...
@Embeddable
public class CustomIdentifierId implements Serializable {

  private UUID deviceId;
  private String name;

  public CustomIdentifierId() {
  }

  public CustomIdentifierId(UUID deviceId, String name) {
  ...
  public boolean equals(Object o) {
    ...
    CustomIdentifierId that = (CustomIdentifierId) o;
