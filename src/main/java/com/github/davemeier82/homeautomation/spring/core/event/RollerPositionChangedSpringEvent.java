...
public class RollerPositionChangedSpringEvent extends ApplicationEvent implements RollerPositionChangedEvent {

  private final DataWithTimestamp<Integer> positionInPercent;

  public RollerPositionChangedSpringEvent(Roller roller, DataWithTimestamp<Integer> positionInPercent) {
    super(roller);
