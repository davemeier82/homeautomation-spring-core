...
public class MotionDetectedSpringEvent extends ApplicationEvent implements MotionDetectedEvent {

  private final ZonedDateTime eventTime;

  public MotionDetectedSpringEvent(MotionSensor sensor, ZonedDateTime eventTime) {
    super(sensor);
