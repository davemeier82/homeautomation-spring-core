...
import com.github.davemeier82.homeautomation.core.device.TemperatureSensor;
import com.github.davemeier82.homeautomation.core.event.DataWithTimestamp;
import com.github.davemeier82.homeautomation.core.event.TemperatureChangedEvent;
import org.springframework.context.ApplicationEvent;

public class TemperatureChangedSpringEvent extends ApplicationEvent implements TemperatureChangedEvent {

  private final DataWithTimestamp<Float> temperatureInDegree;

  public TemperatureChangedSpringEvent(TemperatureSensor source, DataWithTimestamp<Float> temperatureInDegree) {
    super(source);
  ...
  public TemperatureSensor getSensor() {
    return (TemperatureSensor) source;
  }
