...
public class DimmingLevelChangedSpringEvent extends ApplicationEvent implements DimmingLevelChangedEvent {

  private final DataWithTimestamp<Integer> dimmingLevelInPercent;

  public DimmingLevelChangedSpringEvent(Dimmer source, DataWithTimestamp<Integer> dimmingLevelInPercent) {
    super(source);
