...
@Component
public class TestDeviceTypeFactory implements DeviceTypeFactory {
  @Override
  public Optional<? extends DeviceType> createDeviceType(String typeName) {
    if ("test".equals(typeName)) {
      return Optional.of(TestDeviceType.TEST);
    }
